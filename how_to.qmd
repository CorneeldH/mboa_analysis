...
enrollments_basic <- ingest_enrollments_basic() |>
    # TODO studiesucces, doorstroom, uitval etc
...
#### 1.3 Everything related to programmes
...
programme_bc_codes_differences <- programme_bc_codes %>% count(OPLEIDING_niveau, OPLEIDING_niveau_beroep)
