...
print("Succesvol ingeladen en geprepareerdenrollment data")
...
print("Succesvol ingeladen en geprepareerdBPV data")
...
print("Succesvol ingeladen en geprepareerdbackground characteristics data")
...
print("Succesvol ingeladen en geprepareerdmapping tables (dimensions)")
...
print("Succesvol ingeladen en geprepareerdprogramme data")
...
print("Succesvol ingeladen en geprepareerdemployees contract data")
...
print("Succesvol ingeladen en geprepareerdemployees contract extra fte data")
...
print("Succesvol ingeladen en geprepareerdemployees absence data")
...
employees_job_type <-  bind_rows(
    ...
    # TODO this removes a few teachers who have double contracts
    distinct(
        MEDEWERKER_ID, 
...
print("Succesvol ingeladen en geprepareerdemployees job type data")
...
print("Succesvol ingeladen en geprepareerd medewerker tevredenheid data")
...
print("Succesvol ingeladen en geprepareerdretention start data")
