...
#' Run Models for Multiple Groups
#'
#' @description
#' Run models for multiple program-level combinations.
#'
#' @param data The main dataset
#' @param programs Character vector of programs to model
#' @param levels Numeric vector of levels to model
#' @param test_cohort The cohort year to use as test data
#' @param model_type Type of model to use (default: "random_forest")
#' @param aggregate_models Logical indicating whether to also build an aggregate model
#'
#' @return A list of model results for each group and possibly an aggregate model
#'
#' @export
run_group_models <- function(data,
                            programs,
                            levels,
                            test_cohort = 2023,
                            model_type = "random_forest",
